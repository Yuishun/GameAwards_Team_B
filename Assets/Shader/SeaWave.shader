    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_9562 = sin(((1.0 - (node_5041*5.0))+((1.0-node_4560.g)*_sircleSpeed)));
                v.vertex.xyz += (float3(_Wavedirectionxy,_Wavedirectionxy,(_WaveWidth*node_4286))+(_WaveHeight*((_WaveHeightTex_var.g+(((1.0 - smoothstep( 0.7, 1.0, (node_5041*_WaveTop) ))*pow(abs(node_9562),20.0))*0.5))*v.normal)));
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor,(0.5*_AlphaTexture_var.a));
...
/// Final Color:
                float3 finalColor = diffuse + specular;
                float4 _AlphaTexture_var = tex2D(_AlphaTexture,TRANSFORM_TEX(i.uv0, _AlphaTexture));
                fixed4 finalRGBA = fixed4(finalColor * (0.5*_AlphaTexture_var.a),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
